<div class="section-body" id="film">
    <div class="title" style="background:#312b2b4f;margin-top:20px;margin-bottom:25px"><h2>Télé-réalité</h2></div>
    ...
    <div class="pagination">{{ $show->links('livewire.paginate') }}</div>
</div>